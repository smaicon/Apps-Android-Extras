package com.codemaicon.checkbox;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaoMostrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                itensSelecionados += checkBoxCao.getText() + "Status :" + checkBoxCao.isChecked() +"\n";
                itensSelecionados += checkBoxPapagaio.getText() +  "Status :" + checkBoxPapagaio.isChecked()+"\n";
                itensSelecionados += checkBoxGato.getText() +  "Status :" + checkBoxGato.isChecked() + "\n";
